...
pen_res <- tensor_mle(rand_draws, model = "skewt", penalize_nu = TRUE,
                      nu_prior_shape = 3, nu_prior_rate = 0.05)
...
prior_grid <- expand.grid(
  nu_prior_shape = c(1.25, 1.5, 2, 3),
  nu_prior_rate = c(0.025, 0.05, 0.1)
)
