...
print(centered_draws[1:2], entries = 6)

n_prod(centered_draws[1:2], 1, S1)
```
...
- `tensortools()` supports r, d, MLE for all of these distributions
...
- Hand gestures are not correlated while time is strongly correlated
